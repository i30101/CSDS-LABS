...
public class Player extends AnimatedEntity
{
   ...
   protected static final byte NUM_WEAPONS = 15;
   ...
   protected static final byte GREATSHIP = 21;     //for when we sail a great ship
   protected static final byte BRIGANDSHIP = 22;   //for when we sail a briggand skiff
   protected static final byte BOAT = 23;          //for when we are on a row boat
   protected static final byte HORSE = 24;         //for when we ride a horse
   protected static final byte UNICORN = 25;       //for when we ride a unicorn
...
//record the door number we pick (1, 2, 3) for the dungeon puzzle of the 3 doors      
   ...
   {
      int taxes = Math.min(1000, this.getGold() / 10);
