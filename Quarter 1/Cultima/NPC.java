...
//movement types
   ...
   public static final String[] thanksResponseGreater = {"Thou art most welcome", "No, my leige, 'tis I that thank thee", "'Tis an honor to help the great NAME", "'Tis a pleasure to aid thee, NAME"};
   public static final String[] thanksResponseKing = {"Thou may serve my throne any time", "Thou art welcome to serve the throne, NAME", "I dub thee, NAME, as a servant of the royal throne", "NAME shall be welcome in these royal halls"};
   ...
   public static String talk(NPCPlayer selected, String typed)
   {
      ...
      //buy an item from the NPC
         ...
         else if(typed.contains("thank"))
         {
            if(diff > 100 && selected.getCharIndex()!=KING && CultimaPanel.player.getReputation() >= 500)
            {
               response = getRandomFrom(thanksResponseGreater).replace("NAME",CultimaPanel.player.getShortName())+"!";
            }
            else if (selected.getCharIndex()==KING)
            {
               response = getRandomFrom(thanksResponseKing).replace("NAME",CultimaPanel.player.getShortName())+".";
            }
            else
            {
